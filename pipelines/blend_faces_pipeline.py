"""
title: Dual-Node Morpher (OpenAI Images API, Multi-Variant, Compact Traits)
author: Open WebUI Assistant (rewritten)
        ...
        try:
            ...
            for i, img in enumerate(images[:2]):
                ...
                vision_prompt = (
                    ...
                    '"lips": "medium", "jaw": "soft", "notable_marks": "none visible"}'
                )
            ...
            morph_prompt = (
                f"Photorealistic RAW portrait photo of {subject_type}. "
                f"Blend of mixed ethnicity combining features from both parents.\n"
                f"Parent 1 traits: {p1}\n"
                f"Parent 2 traits: {p2}\n"
                "Blend all features naturally: combine ethnicities, merge eye shapes/colors, "
                "nose structures, skin tones, hair colors/textures, face shapes. "
                "Result should show realistic mixed-ethnicity features from both parents. "
                "Natural skin texture (not airbrushed), realistic proportions, neutral background, "
                "soft window light, 85mm lens, shallow depth of field, fine film grain. "
                "Avoid CGI, 3D, illustration, doll-like face, waxy/plastic skin, over-smoothed skin, uncanny eyes."
            )
